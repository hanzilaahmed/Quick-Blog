...
const BlogList = () => {
  ...
  return (
    <div>
            ...
            <div key={item} className='relative'>
                <button onClick={() => setMenu(item)}
                 className={`cursor-pointer text-gray-500  ${menu === item && 'text-white px-4 pt-0.5'}`}>
                    ...
                    transition={{type: 'spring' , stifness:500 , damping:30}}
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 mb-24 mx-8 sm:mx xl:mx-40'>
