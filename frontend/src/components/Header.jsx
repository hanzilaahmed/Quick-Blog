  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Blanditiis odit nihil cumque illo laudantium id assumenda asperiores magni provident nam inventore.</p>
        ...
        <form onSubmit={onSubmitHandler} action="" className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
            <input ref={inputRef} className='w-full pl-4 outline-none' type="text" name="" id="" placeholder='Seacrh for blog' required />
