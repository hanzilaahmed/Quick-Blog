...
const AddBlog = () => {
  ...
  const onSubmiteHandler = async (e) => {
    try {
      ...
      const blog = {
        title, subTitle, description: quilRef.current.root.innerHTML,
  ...
  return (
    <form onSubmit={onSubmiteHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <input className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' type="text" placeholder='Type Here' required name="" id="" onChange={(e) => setTitle(e.target.value)} value={title} />

        <p className='mt-4'>Sub Title</p>
        <input className='w-full max-w-lg mt-2 p-2 border border-gray-300 outline-none rounded' type="text" placeholder='Type Here' required name="" id="" onChange={(e) => setSubTitle(e.target.value)} value={subTitle} />
        ...
        <div className='flex gap-2 mt-4'>
          ...
          <input
            ...
            onChange={(e) => setIsPublished(e.target.checked)} // ✅ use setIsPublished
          />
